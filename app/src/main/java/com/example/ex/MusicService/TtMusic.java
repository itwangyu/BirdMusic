...
import com.example.ex.MusicBean.tt.TiantianDatas;
import com.example.ex.MusicBean.tt.TiantianLrc;
...
public class TtMusic implements IMusic {
    ...
    private static ResultBean search(String key, int page, int size) throws Exception {
        ...
        return new ResultBean(totalsize , GetListByJson(ttDatas.getData()));
    }
