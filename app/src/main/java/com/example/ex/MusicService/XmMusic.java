...
import com.example.ex.MusicBean.xm.XiamiDatas;
import com.example.ex.MusicBean.xm.XiamiIds;
...
public class XmMusic implements IMusic {
    ...
    private static ResultBean search(String key, int page, int size) throws Exception {
        ...
        return new ResultBean(totalsize,GetListByJson(xiamiDatas.getData().getSongs()));
