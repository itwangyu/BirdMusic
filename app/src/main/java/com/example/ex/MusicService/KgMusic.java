...
import com.example.ex.MusicBean.kg.KugouLrc;
import com.example.ex.MusicBean.kg.KugouMp3Url;
import com.example.ex.MusicBean.kg.KugouMv;
import com.example.ex.MusicBean.kg.KugouPic;
...
public class KgMusic implements IMusic {
    ...
    private static ResultBean search(String key, int page, int size) throws Exception {
        ...
        return new ResultBean(totalsize, GetListByJson(data));
    }
