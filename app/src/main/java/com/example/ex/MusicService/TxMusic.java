...
import com.example.ex.MusicBean.tx.TencentDatas;
import com.example.ex.MusicBean.tx.TencentGetKey;
import com.example.ex.MusicBean.tx.TencentMvData;
import com.example.ex.MusicBean.tx.TencentMvKey;
...
public class TxMusic implements IMusic {
    //腾讯支持无损和mv解析
    private static ResultBean search(String key, int page, int size) throws Exception {
        ...
        return new ResultBean(totalsize,GetListByJson(songs.getList()));
    }
